...
//   const isInView = useInView(buttonRef, { once: false, margin: "-50px" }); // trigger every scroll
...
//       title={
//         <>
//           {/* 🌟 Scroll-triggered Purple Button ABOVE Title */}
...
//               animate={
//                 isInView
//                   ? { opacity: 1, filter: "drop-shadow(0 0 23px #a855f7)" }
//                   : { opacity: 0 }
//               }
